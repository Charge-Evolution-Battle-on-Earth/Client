...
### Windows
> CEBE_v1.1.0_win.zip 압축 해제 후 Client.exe 파일 실행
### macOS
> CEBE_v1.1.0_mac.app.zip 압축 해제 후 CEBE_v1.0.31_mac.app 실행 또는 CEBE_v1.0.31_mac.app/Contents/MacOS에서 Client 파일 실행
